                             ...
                             {['SUPERADMIN', 'ADMIN'].includes(user.role) && (
                                <>
                                    ...
                                    <button 
                                        ...
                                        className="px-3 py-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white rounded-lg transition-all shadow-md hover:shadow-lg text-sm font-bold flex items-center gap-2 border border-white/20"
                                    >
